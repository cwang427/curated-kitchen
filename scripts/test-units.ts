/**
 * Pure-logic tests for unit + item pluralization (src/lib/units.ts) and how an
 * ingredient line renders with it (formatIngredient). Guards the "bay leafs" /
 * "bay leaveses" bug.
 *
 *   npm run test:units
 */
import { pluralizeWord, normalizeUnit, unitLabel } from '../src/lib/units'
import { formatIngredient } from '../src/lib/quantity'
